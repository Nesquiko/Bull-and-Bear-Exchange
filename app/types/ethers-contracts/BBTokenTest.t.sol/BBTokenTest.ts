...
export interface BBTokenTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "testSupplyIsSet",
    values?: undefined
  ): string;
...
export interface BBTokenTest extends BaseContract {
  connect(runner?: ContractRunner | null): BBTokenTest;
  waitForDeployment(): Promise<this>;

  interface: BBTokenTestInterface;
  ...
  testSupplyIsSet: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "testSupplyIsSet"
  ): TypedContractMethod<[], [void], "nonpayable">;
